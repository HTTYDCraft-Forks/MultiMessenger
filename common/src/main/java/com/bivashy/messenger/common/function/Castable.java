package com.bivashy.messenger.common.function;
...
public interface Castable<T> {
    ...
    /**
     * Casts this to the provided one. Useful for interfaces or abstract classes. Method will return {@linkplain Optional#empty()} if cannot cast this object
     *
     * @param <R>.  Object that you provided
     * @param clazz R class that will cast this object
    ...
    /**
     * Casts this to the provided one. Useful for interfaces or abstract classes. Method will return default if cannot cast this object
     *
     * @param <R>.         Object that you provided
     * @param clazz        R class that will cast this object
